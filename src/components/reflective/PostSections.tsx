  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-soft)]">
      <div className="flex items-start gap-3 px-5 pt-4">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-reflective-soft text-reflective">
          {icon}
        </div>
        <div className="pb-1">
...
function AlternativePerspectives() {
  ...
  return (
    <SectionShell
      ...
      subtitle="Other ways to look at this — none of them are the answer."
    >
            ...
            <div key={p.id} className="rounded-xl">
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <p className="px-3 pb-3 pt-1 text-[14px] leading-[1.7] text-foreground/80">
                      {p.body}
                    </p>
                  </motion.div>
                )}
...
function VerifyChecklist() {
  ...
  return (
    <SectionShell
      ...
      title="Things worth verifying before acting"
      subtitle="Diligence that usually changes the conversation."
    >
              ...
              <div className="flex items-start gap-3 px-3 py-2.5">
                <button
                  ...
                  className={cn(
                    ...
                    isChecked
                      ? "border-reflective bg-reflective text-reflective-foreground"
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      <motion.p
                        ...
                        className="overflow-hidden text-[13px] leading-[1.6] text-muted-foreground"
                      >
                        {item.detail}
                      </motion.p>
                    )}
